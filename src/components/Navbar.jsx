          ...
          <div className=" flex-1 items-center justify-center sm:items-stretch sm:justify-start sm:flex hidden">
            <Link to="/">
              <div className="flex flex-shrink-0 items-center">
                <TbHexagonLetterJ className="text-white text-5xl" />
                <TbHexagonLetterO className="text-white text-4xl" />
                <TbHexagonLetterB className="text-white text-4xl" />
                <TbHexagonLetterS className="text-white text-4xl" />
                <TbHexagonLetterE className="text-white text-4xl" />
                <TbHexagonLetterA className="text-white text-4xl" />
                <TbHexagonLetterR className="text-white text-4xl" />
                <TbHexagonLetterH className="text-white text-4xl" />
              </div>
            </Link>
