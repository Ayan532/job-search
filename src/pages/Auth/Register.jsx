    ...
    <div className="w-full h-screen flex justify-center items-center">
        ...
        <div className="mt-5 flex flex-col items-center">
                ...
                <div className="mx-auto max-w-xs flex justify-center items-center flex-col gap-4">
                        ...
                        <button
                        type='submit'
                            className="mt-2 tracking-wide font-semibold bg-blue-500 text-gray-100 w-full py-4 rounded-lg hover:bg-blue-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none">
